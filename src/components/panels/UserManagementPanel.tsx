...
export default function UserManagementPanel({ currentUsername }: UserManagementPanelProps) {
  ...
  return (
    <div style={{ backgroundColor: '#ffffff', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', marginTop: '24px' }}>
      <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border-color)' }}>
        <h3 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text-main)', margin: 0 }}>Gerenciar Usuários</h3>
      </div>
      
      <div className={styles.body} style={{ maxHeight: 'none', overflowY: 'visible' }}>
        {/* Left Panel: Create User */}
        <div className={styles.leftPanel}>
          <h4 className={styles.sectionTitle}>Novo Usuário</h4>
        ...
        <div className={styles.rightPanel}>
          <h4 className={styles.sectionTitle}>Usuários Cadastrados</h4>
